/* SAS IML modules from the article 
   ...
   These modules are used to compute the k_th eigenvalue and eigenvector
   ...
   If you %INCLUDE or run this file in SAS, it will store the modules.
   You can them use them in your own program by using 

   load module=_all_;

   or, if you want to be explicit, 

   load module=(SineRationalVec SineRational SineRationalFun GetSineRationalRoots 
             GetPhi GetC EigenvalsAR1 EigenvectorsAR1 AR1Corr);
*/

proc iml;
/* ----- Form the nxn AR(1) matrix for rho ----- */
...
/* Eqn 1: Scalar definition the rational trig function that avoids the undefined value at w=0 */
...
store module=(SineRationalVec SineRational SineRationalFun GetSineRationalRoots 
              GetPhi GetC EigenvalsAR1 EigenvectorsAR1 AR1Corr);
QUIT;
